...
public class Notification_Generator {
    ...
    Notification_Generator(Context context, String text){
     ...
     Notification_Generator(Context context, String text, String title, int priority){
         this.title = title;
         this.text = text;
     ...
     Notification_Generator(Context context, String text, String title, int priority, boolean auto_cancel){
              this.text = text;
              this.title = title;
              this.priority = priority;
